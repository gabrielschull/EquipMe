  ...
  <div className="overflow-y-auto max-h-[400px] mt-4 mb-6 shadow-lg">
    <div>
      {userInfo?.activeRentals?.map((rental: any) => {
        return (
          <>
            <div className="bg-indigo-400 text-white py-3 w-11/12 ml-14 mb-10 rounded">
              <h2 className="text-center text-xl font-semibold align">Your Current Rentals</h2>
            </div>
            <div
              id="marketing-banner"
              className="w-3/4 m-2 bg-white border border-gray-100 rounded-lg shadow-sm lg:max-w-7xl left-1/2 top-6 dark:bg-gray-700 dark:border-gray-600 ml-40 mb-8"
            >
                ...
                <div className="flex items-center ">
                  ...
                  <div className="flex items-center ml-4 mt-4">
                    <Link to={`/rentals/${rental.id}`}>
                      <a className="px-5 py-2 text-s font-medium text-gray-500 bg-whiterounded-lg hover:bg-indigo-400 focus:ring-4 focus:ring-blue-300 dark:bg-blue-600 dark:hover:bg-blue-700 focus:outline-none dark:focus:ring-blue-800 ml-10 rounded hover:text-white">
                        See details
                      </a>
                    </Link>
                  </div>
