...
const AddGear: React.FC = (): JSX.Element => {
  ...
  async function handleSubmit() {
    try {
      ...
      console.log('gearJustAddedInfo in handleSubmit', gearJustAddedInfo);
      // console.log('gearJustAddedInfo in Upload', gearJustAddedInfo);
      ...
      const fileUploads = fileArray.map(
        (file) =>
          supabase.uploadGear(
            file,
