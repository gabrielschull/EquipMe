            ...
            <div className="grid grid-cols-1 gap-x-6 gap-y-8 sm:grid-cols-6">
              ...
              <div className="col-span-full w-1/2">
                ...
                <div className="mt-2 w-full">
                  <textarea
                    placeholder="Example: Camping tent CodeInTheSun 2023"
              ...
              <div className="col-span-full w-1/2">
                ...
                <div className="mt-2">
                  <textarea
                    placeholder="Example: Camping tent 3people size, perfect for festivals or a day in nature"
              ...
              <div className="col-span-full w-1/1">
                <label
                  htmlFor="cover-photo"
                  className="block text-sm font-medium leading-6 text-gray-900">
                  Photos
